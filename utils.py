...
#anglepgan#ach  #TODO - check how this fits with optuna
...
#TODO Caspar commented out this function, probably for optuna processes -- check where this is used
# Op to update the learning rate according to a schedule
...
########################################Caspar #Surfgan #added functions START
#TODO understand how these fit and clean up file
import time
...
########################################Caspar #Surfgan #added functions END
