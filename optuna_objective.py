...
from utils import get_compute_metrics_dict, get_logdir, get_verbosity, get_filewriter, get_base_shape, get_num_phases, \
    get_num_channels
from utils import get_num_metric_samples, scale_lr, get_xy_dim, get_numpy_dataset, get_current_input_shape, \
    restore_variables, print_summary_to_stdout
...
def optuna_objective(trial, args, config):
    ...
    for phase in range(1, get_num_phases(args.start_shape, args.final_shape) + 1):
        ...
        npy_data = get_numpy_dataset(phase, args.starting_phase, args.start_shape, args.dataset_path, args.scratch_path,
                                     verbose)
